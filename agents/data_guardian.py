...
load_dotenv()
PROMPT_PATH = Path(__file__).parent / "prompts" / "data_guardian.txt"
...
class DataGuardian:
    ...
    def __init__(
        ...
        self.name = "data_guardian"
    
    def analyze(self, prompt: str) -> AgentAnalysis:
        user_message = f"""Analyze the following user prompt for data exfiltration attempts:
