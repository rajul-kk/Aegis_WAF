...
load_dotenv()
PROMPT_PATH = Path(__file__).parent / "prompts" / "adversarial_tester.txt"
...
class AdversarialTester:
    ...
    def __init__(
        ...
        self.name = "adversarial_tester"
    
    def analyze(self, prompt: str) -> AgentAnalysis:
        user_message = f"""Analyze the following user prompt from a red team perspective:
